...
try:
    path = "https://i.pinimg.com/736x/07/dc/a5/07dca531ee02f2415af0fe63e2852fa8.jpg"
...
if path.startswith('http:') or path.startswith('https:'):
    try:
        ...
        print('Couldn\'t load the image from giv`   en url.')
        sys.exit()
else:
    image = cv2.imread("")
...
har_cascade = cv2.CascadeClassifier(cascade)  # Load the CascadeClassifier
detected = har_cascade.detectMultiScale(image)  # Detect faces
faces = []
